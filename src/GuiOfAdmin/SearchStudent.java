...
public class SearchStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel1, jLabel10, jLabel2, jLabel3, jLabel5, jLabel9});
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel1, jLabel10, jLabel2, jLabel3, jLabel5, jLabel9});
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            jTextField5.setText(rss.getString("cname"));
             ...
             jTextField7.setText(rss.getString("fine"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String id = (String) jComboBox1.getSelectedItem();
        try{
        db.dbConnect.st.executeUpdate("Delete from student_details where sid = '"+id+"'");
        db.dbConnect.st.executeUpdate("Delete from student_attendence where sid = '"+id+"'");
        db.dbConnect.st.executeUpdate("Delete from library where sid = '"+id+"'");
        db.dbConnect.st.executeUpdate("Delete from student_marks where sid = '"+id+"'");
