    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            InputStream is = new FileInputStream(new File(filename));
                ...
                PreparedStatement ps = db.dbConnect.c.prepareStatement("insert into faculty_details (fid ,fname , subname , image , salary ) values ( ? , ? , ? , ? , ? )");
                ps.setString(1, id);
                ps.setString(2, name);
            ...
            db.dbConnect.st.executeUpdate("update faculty_details set date = '"+cDate+"' where fid = '"+id+"'");
            fillTable();
            JOptionPane.showMessageDialog(null, "Faculty Data Saved Successfully");
